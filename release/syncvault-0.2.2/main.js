...
var SyncVaultSettingsTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(containerEl).setName("Recover sync \u2014 join rebuilt baseline").setDesc("Download the rebuilt baseline to this device. Local files that differ are kept as conflict copies, not deleted.").addButton(
